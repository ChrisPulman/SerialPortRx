...
""";
    ...
    private static void Execute(SourceProductionContext context, Compilation compilation, ImmutableArray<ImmutableArray<StreamInfo>> streamInfoGroups)
    {
        ...
        {
            GenerateForType(context, (INamedTypeSymbol)typeGroup.Key, typeGroup.Value, serialPortNamespace);
        }
    }
    ...
    private static string GenerateType(INamedTypeSymbol targetType, IReadOnlyList<StreamInfo> streams, string serialPortNamespace)
    {
    ...
    private static void AppendStreamMembers(StringBuilder builder, StreamInfo stream, string serialPortNamespace)
    {
        ...
        _ = builder.Append("    public global::ReactiveUI.Primitives.Async.IObservableAsync<")
            ...
            .Append(serialPortNamespace)
            .Append(".ObservableAsyncBridgeExtensions.ToObservableAsync(")
            .Append(stream.PropertyName)
    ...
    private static void AppendSubscription(StringBuilder builder, StreamInfo stream, string serialPortNamespace)
    {
        ...
        _ = builder.AppendLine("#if REACTIVE_SHIM");
        AppendSubscriptionCore(builder, stream, typeName, fieldName, "global::ReactiveUI.Primitives.SubscribeExtensions", serialPortNamespace);
        _ = builder.AppendLine("#else");
        AppendSubscriptionCore(builder, stream, typeName, fieldName, "global::ReactiveUI.Primitives.SubscribeExtensions", serialPortNamespace);
        _ = builder.AppendLine("#endif");
    }
